...
<html lang="en">
    <head>
        <head>
            ...
            <link rel="stylesheet" type="text/css" href="./rentproperty.css">
            <title>Real Home | Rent Property Page</title>
    </head>
    <body>
        <header>
        <br/>
        ...
        <br/>
        <h1 class="rentpageheading">Rent your Dream Property</h1>
        ...
        <button class="close-button" onclick="closePopup()">✖</button>
            <div class="rentpropertyboxdetails">
            <h1 class="rentpropertyheading">Property Details</h1>
        ...
        <br/>
        <script src="./rentproperty.js"></script>
        <footer>
